  ...
  <div className=" container">
    ...
    <div className="row py-4">
      ...
      <img src="/public/smalllogo.jpg"className='img-fluid ' alt="error" />
        ...
        <ul className="text-sm  list-none pt-2">
          ...
          <li className=""><a href="/" className=" ">aimsproperty@gmail.com</a></li>
      ...
      <div className="col-md-2 ">
        ...
        <ul className="text-sm  list-none">
        <li className="mb-6"><a href="/houses"  >Houses</a></li>
                        <li className="mb-6"><a href="/plots"  >Plots</a></li>
                        <li className="mb-6"><a href="/rentproperties">Rent</a></li>
                        <li className="mb-6"><a href="/saleproperties"  >Sale</a></li>
                        <li><a href="/commercialareas"  > Commercials</a></li>
      ...
      <div className="col-md-2 ">
        ...
        <ul className="text-sm  list-none">
        <li className="mb-6"><a href="/houses"  >Houses</a></li>
        <li className="mb-6"><a href="/">FAQs</a></li>
          <li className="mb-6"><a href="/" >Quick Start</a></li>
          <li className="mb-6"><a href="/" >Documentation</a></li>
      ...
      <div className="col-md-2 ">
        ...
        <ul className="text-sm  list-none">
        <li className="mb-6"><a href="/" className="text-gray-600 hover:text-gray-900">Pearl One, 94-B/I,  Pakistan</a></li>
          <li className="mb-6"><a href="/" className=" text-gray-600 hover:text-gray-900"> Monday To Sunday 9AM To 6PM</a></li>
    ...
    <div className="pt-3 border-top border-gray-500">
      <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
        <span className="text-sm text-gray-500 ">©<a href="https://pagedone.io/">Aims Property</a> 2024, All rights reserved.</span>
